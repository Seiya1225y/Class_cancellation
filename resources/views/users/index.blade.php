        ...
        <div class="p-3">
            ...
            <div class="tab-content">
                ...
                <div id="kamoku" class="tab-pane">
                    <div class="tab-content">
                        <form class="form-inline" method="post" action="youbi.php">
                            <div class="form-group">
                                <label for="youbi" class="control-label col-xs-2">曜日：</label>
                                <div class="col-xs-3">
                                    <select class="form-control" id="youbi" name="youbi[]">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-3">
                                    <select class="form-control" id="zikan" name="zikan[]">
                                        <option value="1">1</option>
                                        <option value="2">2</option>
                                        <option value="3">3</option>
                                        <option value="4">4</option>
